  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50">
      ...
      <div className="relative">
        ...
        <Link
          href="/add"
          className="absolute left-1/2 transform -translate-x-1/2 top-1/2 -translate-y-1/2 z-40 w-12 h-12 bg-blue-600 hover:bg-blue-700 rounded-full flex items-center justify-center shadow-lg transition-colors duration-200"
